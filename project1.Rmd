...
rawfile <- trimws(str_replace_all(readLines("D:/CUNYSPS-MSDS/Project1/tournamentinfo.txt"),"-----------------------------------------------------------------------------------------",""))
...
write.table(df_result, file = "D:/CUNYSPS-MSDS/Project1/df_result.csv", row.names = F, col.names=FALSE, sep = ",")
